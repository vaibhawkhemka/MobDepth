...
def create_model(existing='', is_twohundred=False, is_halffeatures=True):
    ...
    if len(existing) == 0:
        ...
        if is_twohundred:
            ...
            base_model = applications.MobileNet(input_shape=(None,None, 3), include_top=False)
        ...
        decoder = upproject(decoder, int(decode_filters/2), 'up1', concat_with='conv_pw_6')
        decoder = upproject(decoder, int(decode_filters/4), 'up2', concat_with='conv_pw_4')
        decoder = upproject(decoder, int(decode_filters/8), 'up3', concat_with='conv_pw_2')
        decoder = upproject(decoder, int(decode_filters/16), 'up4', concat_with='conv_pw_1')
